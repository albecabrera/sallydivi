...
- Enforce severity caps and comment budgets by PR size.
...
- Ask, do not tell. Directives are reserved for **issue (blocking)** with **Blocker** severity.
...
- If confidence is below `concern_min`, downgrade to Nit.
- If confidence is below `blocker_min`, downgrade Blocker to Concern.
- Enforce `severity_caps` per severity.
  ...
  "findings": [
    {
      ...
      "comment_label": "issue | suggestion",
...
- Respect confidence thresholds and severity caps.
