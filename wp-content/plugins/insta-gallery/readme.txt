...
= 5.0.4 =
* Fix: Clear orphaned feed account references when an account is deleted to prevent account ID mismatch errors
* Fix: Frontend REST permission callback now reads account_id from the request object instead of $_GET
